class PatientDataController < ApplicationController
  ...
  # TODO -  Please fetch all available patients that are born after 1950.
  ...
  def fetch_data
    ...
    @raw_json["entry"].each do |entry|
      ...
      begin
        first_name = parse_info(entry["resource"]["name"][0],"given")
      rescue
        first_name = ' '
      end
    ...
    if sum_age != 0
      @average_age = sum_age / counter_have_age
    end
